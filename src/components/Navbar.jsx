...
const Navbar = ({ id }) => {
  return (
    <div className="w-[4.375rem] h-full fixed lef-0 top-0 flex flex-col justify-between border-r border-gray-200 px-4 py-10 z-10">
      <a href="/#home">
        <span className="text-3xl font-semibold text-red-400">V</span>.
        <span className="block w-min rotate-90 origin-bottom text-xs font-semibold">
          Hieu
        </span>
      </a>
      <div className="flex flex-col  gap-y-3 sm:gap-y-2">
        {navbarData.map((item, i) => (
          ...
          >
            ...
            <span
              className={`text-[0.625rem] tracking-wide opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 text-center ${
      ...
      <p className="flex items-center justify-center text-[0.8125rem] text-gray-500 mt-6">
