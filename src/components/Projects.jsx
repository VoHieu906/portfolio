...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen py-20 " id="projects">
      ...
      <div className="flex flex-wrap items-center justify-between py-10 px-2">
        {projectsButton.map((text, i) => (
          <motion.button
            ...
            className="border border-yellow-500 rounded-xl px-2 py-1 text-sm font-light tracking-wider text-gray-500"
          >
            {text}
          </motion.button>
        ))}
